...
const PRESETS: Record<string, Partial<GameConfig>> = {
  beginner:     { rows: 9,  cols: 9,  minesTotal: 30,  maxMinesPerCell: 3, density: 0.7 },
  intermediate: { rows: 16, cols: 16, minesTotal: 60,  maxMinesPerCell: 4, density: 0.6 },
  expert:       { rows: 16, cols: 30, minesTotal: 240, maxMinesPerCell: 6, density: 0.6 },
